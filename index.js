...
async function main() {
    ...
    p.intro(`${color.bgCyan(color.black(' create-project-template-app '))}`);
...
if (args.length > 0 && args[0] === 'generate') {
    main().catch(console.error);
		...
		let availableCommands = `project-template generate`;
...
// 			p.outro(`Problems? ${color.underline(color.cyan('https://nuflakbrr.vercel.app/'))}`);
// 			process.exit(0);
// 		}
