...
description: Learn about the Next.js JavaScript framework template.
---

## Nextjs Template Starter Kit (JavaScript)
...
You can start editing the page by modifying `/src/components/Containers/Home/Home.jsx`. The page updates automatically as you edit the file.
...
[API Routes](https://nextjs.org/docs/api-routes/introduction) can be accessed at [http://localhost:3000/api/hello](http://localhost:3000/api/hello). This endpoint can be edited in `/src/app/api/hello.js`.
