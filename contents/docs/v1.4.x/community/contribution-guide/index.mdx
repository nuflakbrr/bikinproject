...
<StepperItem title="Create new branch">
...
<StepperItem title="Create new template"></StepperItem>

<StepperItem title="Push to the branch">
...
```bash
git clone https://github.com/nuflakbrr/fullstack-template.git
```
