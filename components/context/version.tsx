...
export default function VersionContextProvider({ children }: PropsWithChildren) {
  const [currentVersion, setCurrentVersion] = useState<Version>(() => {
    return (localStorage.getItem(localStorageVersionKey) ?? availableVersions[0]) as Version;
  });
